        ...
        <div class="col-md-12 col-xs-12">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="fname">Member No</label>
                            <input type="text" class="form-control"  value="<?php echo $application_data['id'] ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="username"></label>
                            <a href="<?php echo base_url('Members');?>" class="btn btn-success btn-bg">Back</a>
                        </div>
                    </div>
                </div>
